...
def ft_load(path: str) -> np.array:
    ...
    try:
        ...
        assert ext in ['.jpg', '.jpeg'], f"Unsupported file format '{ext}'. Only .jpg and .jpeg are supported."
        ...
        # Catch other errors (like issues with opening the image) and print them
